...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center relative z-10 px-4 py-8 md:px-6 md:py-12">
      <div className="relative flex flex-col items-center w-full max-w-2xl px-6 py-8 bg-gray-800 rounded-lg shadow-lg gap-6">
        ...
        <form ref={form} onSubmit={handleSubmit} className="w-full bg-gray-700 p-8 rounded-lg shadow-md space-y-4">
